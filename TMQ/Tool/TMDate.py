...
#     # date_list = ['20181220', '20181221', '20181212', '20180103','20160202','20140101']
#     date_list = [datetime.datetime.strptime(d, '%Y%m%d') for d in date_list]
#     date_list.sort()
...
def incise_date_into_block(date_list, max_period):
    ...
    li = [[(s - datetime.timedelta(days=a)).strftime("%Y%m%d") for a in range(max_period)] for s in sd]
    date_df = pd.DataFrame(li)
